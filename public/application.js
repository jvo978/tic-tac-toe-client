...
var playerXwins = function playerXwins(event) {
  $('#messageStatus').html('Player X Wins!!');
};
var playerOwins = function playerOwins(event) {
...
var onUpdateGame = function onUpdateGame(event) {
  ...
  api.updateGame(event).then(ui.updateGameSuccess).catch(ui.updateGameFailure);
};
module.exports = {
  onSignUp: onSignUp,
  onSignIn: onSignIn,
